                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 bg-[#0EA5A5] hover:bg-[#0c8e8e] text-white rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2"
                    >
                      {otpSent ? 'Resend' : 'OTP'}
                      <Send size={12} />
                    </button>
