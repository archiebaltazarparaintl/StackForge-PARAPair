...
export default function ListingsPage() {
  ...
  return (
    <main className={`${exo2.className} min-h-screen bg-[#0D1B2A] text-white`}>
      {/* HEADER */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <h1 className="text-xl font-[800] italic tracking-tighter uppercase leading-none">
                Listing <span className="text-[#0EA5A5]">Management</span>
              </h1>
              <span className="text-[9px] font-black uppercase tracking-[0.3em] text-white/30 tracking-widest">Manage Your Opportunities</span>
            </div>
          </div>
        </div>
      </header>
