...
export default function PasswordField({
  label, value, onChange, showPassword, setShowPassword,
  error, success, onFocus, onBlur,
}: Props) {
  return (
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`
            ...
            pl-12 pr-12 text-sm outline-none transition-all
            focus:ring-4 focus:ring-[#0EA5A5]/10 focus:border-[#0EA5A5]
            ${error ? 'border-red-400' : success ? 'border-emerald-500' : 'border-slate-200'}
          `}
        />
        <button
          type="button"
