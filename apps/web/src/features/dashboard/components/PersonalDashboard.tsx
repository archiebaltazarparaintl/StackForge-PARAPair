...
export default function PersonalDashboard() {
  ...
  return (
    <>
      <Navbar />
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 pb-12 pt-24 text-white">
      ...
      <div className="bg-white/5 border border-white/10 rounded-[40px] p-8 backdrop-blur-xl h-fit">
        <div className="flex flex-col items-center text-center">
          ...
          <button 
            ...
            className="w-full mt-12 py-5 bg-[#FF7A00] text-white rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] hover:scale-105 active:scale-95 transition-all shadow-xl shadow-[#FF7A00]/20"
          >
            Edit Forge Identity
          </button>
        </div>
